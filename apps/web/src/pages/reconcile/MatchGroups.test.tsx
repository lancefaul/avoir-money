...
describe('combining rows that add up', () => {
  const tour: ResolutionItem = {
    ...
    apps: [
      ...
      { id: 'a2', date: '2026-02-05', name: 'Ticketmaster', amount: 300 },
    ],
    delta: 0,
  };
  ...
  it('offers no free-form correction', () => {
    ...
    renderGroups({ combinations: [tour] });
...
describe('merging a combination', () => {
  ...
  it('offers "Merge them" for a same-type combination and stages the merge with its parts', async () => {
    ...
    expect(stagedFor(onStage, 'combo-tm')).toMatchObject({
      ...
      name: 'TM *ACME TOUR',
      parts: [
        { transactionId: 'a1', amount: 300, recurringLink: false, scheduledMatch: false },
        { transactionId: 'a2', amount: 300, recurringLink: true, scheduledMatch: true },
      ],
    });
  });
