...
export default function Layout() {
  ...
  return (
    /*
     * The provider wraps everything including the title bar, so the privacy
     * toggle's own tooltip and any future masked chrome are covered by the
     * same switch as the page.
     */
