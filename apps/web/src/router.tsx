...
const settingsRoute = createRoute({
  getParentRoute: () => rootRoute,
  path: '/settings',
  // `?tab=<name>` opens Settings on a specific pane. Added for the title bar's
  // update affordance, which has to be able to point AT something — the tab was
  // local state before, so "open Settings on Software Updates" was not
  // expressible as a link. Unvalidated names fall through to the default rather
  // than erroring: a stale or hand-typed link should land on Settings, not on a
  // crash.
