...
/**
 * Empire OLED — Empire Dark with the Midnight (theme-midnight) neutral ramp.
 *
 * **The name and the donor do not match, deliberately.** This theme is named
 * OLED and is built from `theme-midnight`; its sibling `theme-empire-midnight`
 * is named Midnight and is built from `theme-dark` (labelled "Ash"). The names
 * were chosen for how the themes read on screen, after the fact. Do not
 ...
 * or not at all.
 */
export const empireOledTheme = createTheme(vars, {
  color: {
    ...
    secondaryButtonFrom: 'oklch(14% 0.014 250)', // = neutral0
    secondaryButtonTo: 'oklch(5.8% 0.015 250)', // = neutral50
    secondaryButtonHoverFrom: 'oklch(18% 0.013 250)', // = neutral100
    secondaryButtonHoverTo: 'oklch(14% 0.014 250)', // = neutral0
    secondaryButtonBorder: 'oklch(20% 0.014 250)', // = neutral200
    ...
    neutral0: 'oklch(14% 0.014 250)',
    neutral25: 'oklch(9.9% 0.0145 250)',
    neutral50: 'oklch(5.8% 0.015 250)',
    neutral100: 'oklch(18% 0.013 250)',
    neutral200: 'oklch(20% 0.014 250)',
    neutral300: 'oklch(26% 0.016 250)',
    neutral400: 'oklch(40% 0.015 250)',
    neutral450: 'oklch(61.10% 0.013 250)',
    neutral500: 'oklch(36% 0.015 250)',
    neutral600: 'oklch(72.60% 0.012 250)',
    neutral700: 'oklch(78.40% 0.010 250)',
    ...
    surfaceRaised: 'oklch(5.8% 0.015 250)', // = neutral50
    surfaceOverlay: 'oklch(5.8% 0.015 250)', // = neutral50
    ...
    controlHover: 'oklch(18% 0.013 250)', // = neutral100
    sidebarSurface: 'oklch(5.8% 0.015 250)', // = neutral900
    ...
    textTertiary: 'oklch(61.10% 0.013 250)', // = neutral450
    ...
    textPlaceholder: 'oklch(61.10% 0.013 250)', // = neutral450 (= textTertiary)
    textInverse: 'oklch(96.1% 0.009 161.4)', // = brand900 — lightest
    textOnBrand: 'oklch(5.8% 0.015 250)', // = neutral50
    onAccent: 'oklch(5.8% 0.015 250)', // = textOnBrand = neutral50
    ...
    onSuccess: 'oklch(5.8% 0.015 250)', // = neutral50
    onWarning: 'oklch(5.8% 0.015 250)', // = neutral50
    onDanger: 'oklch(5.8% 0.015 250)', // = neutral50
    onInfo: 'oklch(5.8% 0.015 250)', // = neutral50
    onNeutral: 'oklch(5.8% 0.015 250)', // = neutral50

    // -- Overlay --
    overlay: 'rgba(0, 0, 0, 0.6)',

    // -- Input --
    inputBg: 'oklch(14% 0.014 250)', // = neutral0
    inputBgHover: 'oklch(18% 0.013 250)', // = neutral100
    inputBgDisabled: 'oklch(5.8% 0.015 250)', // = neutral50
    inputBorder: 'oklch(20% 0.014 250)', // = neutral200
    inputBorderHover: 'oklch(26% 0.016 250)', // = neutral300
